...
const zoneUtil = {
    ...
    , zoneEmbed: (zone, hs, hp, gold) => {
        let time = zoneUtil.instakill(zone);
    ...
    , monsterHp: (zone) => {
        ...
        if (zone <= 140) {
            ...
            let zoneH = zoneUtil.monsterByFiveHun(zoneFM);
        ...
        if (zone % 5 == 0) {
            health = health.times(zoneUtil.bossHPMulti(zone));
        }
    ...
    , instakill: (zones) => {
        ...
        return zoneUtil.formatTime(seconds);
    }
